...
class EditLibroPage extends StatefulWidget {
  const EditLibroPage({super.key});

  @override
  State<EditLibroPage> createState() => _EditLibroPageState();
}

class _EditLibroPageState extends State<EditLibroPage> {
  ...
  Widget build(BuildContext context) {
    final Map libro = ModalRoute.of(context)!.settings.arguments as Map;
    for (var key in controllers.keys) {
      controllers[key]!.text = libro[key].toString();
    }

    return Scaffold(
      appBar: AppBar(
        title: const Text("Editar Libro", style: TextStyle(color: Colors.white)),
            ...
            for (var key in controllers.keys)
              Padding(
                ...
                child: TextField(
                  ...
                  keyboardType: (key == 'precio' || key == 'cantidad')
